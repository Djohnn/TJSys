...
export default function ProductMediaPanel({ productId }: ProductMediaPanelProps): ReactNode {
  ...
  return (
    <div data-testid="product-media-panel" className="border-2 border-dashed border-neutral-300 rounded-xl p-6 text-center min-h-64">
      ...
      <p className="text-sm text-neutral-700 font-medium">Upload de Imagens</p>
      <p className="text-xs text-neutral-700 mt-1">Arraste ou clique para adicionar imagens do produto</p>
      <button
        type="button"
      ...
      {!productId && <p className="text-xs text-neutral-700 mt-2">Salve a identificação antes de adicionar imagens.</p>}
