...
**Dependências:** F4, F6, F10

## Objetivo

Entregar loja virtual e marketplaces como incremento vertical, tenant-safe, acessível e verificável, sem quebrar os fluxos já publicados.

## Escopo

- Loja virtual, marketplaces e pedidos online.
- Publicação de catálogo/preço/estoque.
- Inbox idempotente e reconciliação.

## Fora do escopo

- Canais sem contrato assinado.
- Compartilhar credenciais entre tenants.

## Contrato funcional

ChannelProfile guarda credencial cifrada; external_order_id é único por canal e publicação usa outbox.
...
> Quando um pedido externo é reenviado, uma única venda/pedido interno é criado e estoque permanece consistente.
