...
Entregar tokens e componentes fundamentais como incremento vertical, tenant-safe, acessível e verificável, sem quebrar os fluxos já publicados.

## Escopo

- Criar tokens CSS e TypeScript a partir da paleta aprovada.
- Consolidar Button, Input, Select, Textarea, Switch, Tabs, Card, Alert, Badge, Modal e Table.
- Cobrir estados hover, focus, disabled, loading, erro e responsividade.

## Fora do escopo

- Migrar páginas completas.
- Alterar contratos de negócio.

## Contrato funcional

Componentes aceitam variantes sem expor valores HEX e preservam semântica ARIA.
...
> Quando uma página usa componentes fundamentais, nenhuma cor literal nova é introduzida e foco/contraste passam no axe.
