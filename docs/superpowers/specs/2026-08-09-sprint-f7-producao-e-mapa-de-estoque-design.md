...
Entregar produção e mapa de estoque como incremento vertical, tenant-safe, acessível e verificável, sem quebrar os fluxos já publicados.

## Escopo

- Ordens de produção.
- Consumo de composição e entrada de acabado.
- Mapa por filial, local e grade.
...
ProductionOrder reserva insumos e, ao concluir, consome componentes e recebe acabado atomicamente.
...
> Quando uma ordem é concluída, insumos e acabado mudam na mesma transação ou nada muda.
