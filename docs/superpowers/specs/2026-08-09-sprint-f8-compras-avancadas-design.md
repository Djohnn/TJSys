...
Entregar compras avançadas como incremento vertical, tenant-safe, acessível e verificável, sem quebrar os fluxos já publicados.

## Escopo

- Cotações de fornecedores e comparação.
- Compras em aberto e devoluções.
- Integração estoque, custo e financeiro.
...
SupplierQuote converte para PurchaseOrder idempotente; devolução referencia recebimento e reverte estoque/financeiro.
...
> Quando recebimento é devolvido, saldo e obrigação financeira são compensados sem exceder a quantidade recebida.
