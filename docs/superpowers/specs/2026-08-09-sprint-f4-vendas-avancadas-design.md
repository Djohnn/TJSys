...
Entregar vendas avançadas como incremento vertical, tenant-safe, acessível e verificável, sem quebrar os fluxos já publicados.

## Escopo

- Consignados, comissões, listas de preço e serviços.
- Regras por público, vigência e condição.
- Liquidação e devolução de consignação.
...
Resolver de preço seleciona uma regra efetiva única; comissão deriva de venda confirmada e estorno.
...
> Quando uma venda elegível é confirmada e depois estornada, comissão e estoque acompanham os dois eventos.
