...
Entregar crm e jornada do cliente como incremento vertical, tenant-safe, acessível e verificável, sem quebrar os fluxos já publicados.

## Escopo

- Pipeline, oportunidades, atividades e histórico.
- Vínculo com Person, vendas e devoluções.
- Consentimento e controle de acesso.

## Fora do escopo

- Automação de marketing externa.
- Armazenar dados sem finalidade.

## Contrato funcional

CRMOpportunity referencia Person tenant-scoped; Timeline projeta eventos sem copiar PII desnecessária.
...
> Quando uma oportunidade avança, histórico registra ator/data e usuários sem permissão não acessam o cliente.
