...
export interface ElectronAPI {
  ...
  // Sales
  createSale(data: SaleInput): Promise<ElectronResult<Sale | OfflineSaleResult>>;
  ...
  getSaleReceipt(saleId: string): Promise<ElectronResult<{ html: string }>>;
  printReceipt(data: PrintReceiptInput): Promise<PrintReceiptResult>;
  printFiscalReceipt(data: PrintReceiptInput): Promise<PrintReceiptResult>;
  printBalcaoReceipt(data: PrintReceiptInput): Promise<PrintReceiptResult>;
...
const mockElectronAPI: ElectronAPI = {
  ...
  getSaleReceipt: async (_saleId) => ({ success: true, data: { html: '<html>Mock Receipt</html>' } }),
  printReceipt: async (_data) => ({ success: true, savedPath: '/mock/receipt.pdf' }),
  printFiscalReceipt: async (_data) => ({ success: true, savedPath: '/mock/fiscal.pdf' }),
  printBalcaoReceipt: async (_data) => ({ success: true, savedPath: '/mock/balcao.pdf' }),
